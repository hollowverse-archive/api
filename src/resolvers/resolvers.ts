...
import { resolvers as changeNotablePersonEventApprovalStatusResolvers } from './mutations/changeNotablePersonEventApprovalStatus';
...
export const resolvers = merge(
  ...
  changeNotablePersonEventApprovalStatusResolvers,
